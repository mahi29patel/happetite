  ...
  return (
    ...
    <div className="card" style={{width:'1000px', margin: '0 auto', boxShadow: 'rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px'}}>
      <div className="row no-gutters">
       <div className="col-md-4" style={{backgroundColor:'transparent !important'}}>
        <img src={lady} width="100%" height="100%"/>
        </div>
        <div className="col-md-8" style={{backgroundColor:'white'}}>
          <div className="card-body" style={{margin:'10px',width:'620px',alignContent:'center', color:'black'}}>
            <h5 >Dear participants, I welcome you all to this program.
            <br></br><br></br>
            <div className="head1" style={{fontWeight:'normal'}}>
